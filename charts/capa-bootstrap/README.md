...
A Helm Chart for the cluster-api-provider-aws eks-bootstrap provider
...
| controllerManager.manager.image.repository | string | `"k8s.gcr.io/cluster-api-aws/eks-bootstrap-controller"` |  |
